...
export default function Landing() {
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/*MAIN DESKTOP*/}
      <div className="hidden md:grid grid-cols-2 px-10 pt-24">
        {/* LEFT COLUMN */}
      ...
      {/* MOBILE LAYOUT */}
      <div className="md:hidden px-6 pt-10 flex flex-col">
        ...
        {/* Tooltip */}
        <div className="absolute right-[30%] bottom-[25%] text-white text-[10px]">
          <div className="tooltip">
            <Image
              src="/info.png"
              width={10}
